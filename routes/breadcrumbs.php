...
Breadcrumbs::register('vin', function ($breadcrumbs) {
    $breadcrumbs->parent('main');
    $breadcrumbs->push(Lang::get('breadcrumbs.vin'), route('vin'));
});

Breadcrumbs::register('more', function ($breadcrumbs) {
    $breadcrumbs->parent('vin');
    $breadcrumbs->push(Lang::get('breadcrumbs.more'), route('vin'));
});
