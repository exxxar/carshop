            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 product">
                    <div class="row product-show">
                        <div class="col-sm-5">
                            @if($product->img!='/images/products/')
                                <img src="{{ asset($product->img) }}"
                                     alt="{{ $product->title }}" class="image-response">
                            @else
                    ...
                    <div class="row">
                        <div class="col-sm-12 hidden-xs">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#analog" data-toggle="tab">@lang('page.analog')</a></li>
                                <li><a href="#details" data-toggle="tab">@lang('page.details')</a></li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active text-justify" id="analog">
                                    @include('partials.product.analogs')
                                </div>

                                <div class="tab-pane text-justify" id="details">
                                    {{ $product->description }}
                                </div>
