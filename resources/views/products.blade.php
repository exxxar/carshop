                    ...
                    <div class="col-sm-12 hidden-xs">
                        <div class="products-options">
                            ...
                            <div class="products-layouts">
                                <button class="showType active" id="product-table" data-show="table"><i class="fa fa-bars fa-lg" aria-hidden="true"></i></button>
                                <button class="showType " id="product-grid" data-show="grid"><i class="fa fa-th fa-lg" aria-hidden="true"></i></button>
